...
import com.hoanhtuan.boardingpasshdbank.controller.PassengerController;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleAuthenticationException(AuthenticationException ex) {
        // logging here
        final String METHOD_NAME = "handleAuthenticationException";
        WriteLog.errorLog(CLASS_NAME, METHOD_NAME, ex.getMessage());
        ErrorMessage response = ErrorMessage.builder()
    ...
    public ResponseEntity<ErrorMessage> handleForbiddenException(ForbiddenException ex) {
        // logging here
        final String METHOD_NAME = "handleForbiddenException";
        WriteLog.errorLog(CLASS_NAME, METHOD_NAME, ex.getMessage());
        ErrorMessage response = ErrorMessage.builder()
    ...
    public ResponseEntity<ErrorMessage> handleNotFoundException(NotFoundException ex) {
        // logging here
        final String METHOD_NAME = "handleNotFoundException";
        WriteLog.errorLog(CLASS_NAME, METHOD_NAME, ex.getMessage());
        ErrorMessage response = ErrorMessage.builder()
