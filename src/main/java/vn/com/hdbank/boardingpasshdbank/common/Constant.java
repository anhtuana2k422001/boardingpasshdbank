...
public class Constant {
    ...
    public static final String FORMAT_EXCEPTION = "Error: code:{}, message: {}";
    ...
    public static final String VIET_JET_LUCKY_CONTENT = "Hoàn tiền chương trình DatabaseValidation Daily Lucky";
