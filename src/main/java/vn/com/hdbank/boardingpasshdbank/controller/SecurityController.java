...
//    public ResponseEntity<ResponseInfo<TokenResponse>> authenticate(@RequestBody Map<String,String> loginDto) {
...
//        List<String> rolesNames = new ArrayList<>();
//        rolesNames.add("User");
//        var response =  jwtUtilities.generateToken("thanhcong", rolesNames);
